              ...
              >
                ...
                <div className="flex-grow text-left overflow-hidden">
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-black text-xs text-slate-800 tracking-tighter truncate w-24">
                      {room.visitor_id.substring(0, 12)}...
                    </span>
                  ...
                  <p className="text-[10px] text-slate-500 font-medium truncate italic">
                    {room.last_message || "Yeni Konuşma"}
                  </p>
                </div>
              </button>
            ))
          ...
          <>
            ...
            <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-white z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-black text-slate-800 text-sm tracking-tight">{activeRoom.visitor_id}</h4>
